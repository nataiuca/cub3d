...
/*   Updated: 2025/10/15 12:42:31 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_player(t_minimap *minimap, t_player *player)
{
...
static void	draw_sprite_minimap(t_minimap *minimap, t_sprite *sprite)
{
	int		x;
	int		y;
...
static void	draw_grid_sprites(t_game *game)
{
	int		x;
	int		y;
	char	cell;
